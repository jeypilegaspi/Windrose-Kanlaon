...
This repository contains the python script for windrose generator created specifically for Kanlaon wind data along with the json files that contains the wind data.
